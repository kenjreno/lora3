...
const
  ...
  Crc32Tab: array[0..255] of LongWord = (
    ...
    $0EDB8832, $79DCB8A4, $E0D5E91B, $97D2D988,
    $09B64C2B, $7EB17CBD, $E7B82D09, $90BF1D9F,
    ...
    $35B5A8FA, $42B2986C, $DBBBF9D2, $ACBCF940,
    $32D86CE3, $45DF5C75, $DCD60DCF, $ABD13D59,
    $26D930AC, $51DE003A, $C8D75180, $BFD06116,
    $21B4F6B5, $56B3C423, $CFBA9599, $B8BDA50F,
    ...
    $44042D73, $33031DE5, $AA0A4C5F, $DD0D7822,
    $5005713C, $270241AA, $BE0B1010, $C90C2086,
    $5768B525, $206F85B3, $B966D409, $CE61E49F,
    $5EDEF90E, $29D9C998, $B0D09822, $C7D7A8B4,
    $59B33D17, $2EB40D81, $B7BD5C3B, $C0BA6CFD,
    ...
    $DF60EFC3, $A8670955, $31601838, $46672868,
...
begin
  ...
  Result := (tv.tv_sec * 100) + (tv.tv_usec div 10000) + lHund;
end;
...
begin
  fpgettimeofday(@tv, nil);
  now_ := (tv.tv_sec * 100) + (tv.tv_usec div 10000);
  if now_ >= lEndtime then
    Result := 1
  else
    Result := 0;
end;
